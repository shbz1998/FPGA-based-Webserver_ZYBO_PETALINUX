...
HD_PWD='C:/Users/malik/Documents/ECE_520_PROJECTS/LAB11_MALIK/LAB11_MALIK.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log webserver_design_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source webserver_design_wrapper.tcl -notrace
