...
HD_PWD='C:/Users/malik/Documents/ECE_520_PROJECTS/LAB11_MALIK/LAB11_MALIK.runs/webserver_design_auto_pc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log webserver_design_auto_pc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source webserver_design_auto_pc_0.tcl
